pipeline {
    ...
    stages {
        ...
        stage ('API Test') {
            steps {
                dir('api-test') {
                git credentialsId: 'githublogin', url: 'https://github.com/gustavoivo/tasksapitest'
                sh 'mvn test' 
            }
        }
    }
        stage ('Deploy FrontEnd') {
            steps {
                dir('frontend') {
                  git credentialsId: 'githublogin', url: 'https://github.com/gustavoivo/tasks-frontend'
